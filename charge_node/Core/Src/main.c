...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(BQ_nQON_GPIO_Port, BQ_nQON_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(BQ_nCE_GPIO_Port, BQ_nCE_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin : BQ_nQON_Pin */
  GPIO_InitStruct.Pin = BQ_nQON_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(BQ_nQON_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : BQ_nCE_Pin */
  GPIO_InitStruct.Pin = BQ_nCE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
